                ...
                <div class="card mb-4">
                            ...
                            @csrf
                                <div class="form-row">
                                    ...
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror" id="inputNama" placeholder="Nama" name="nama" value="{{ $user->nama }}">
                                    @error('nama')
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="inputJabatan" class="form-control @error('jabatan') is-invalid @enderror" name="jabatan">
                                        ...
                                        <option vlaue="Admin" {{ $user->jabatan == 'Admin' ? 'selected' : '' }}>Admin</option>
